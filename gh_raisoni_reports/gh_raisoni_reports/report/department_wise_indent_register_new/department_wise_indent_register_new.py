...
def get_columns():
    return [
        ...
        {
            "label": "Purchase Req Qty",
            "fieldname": "purchase_req_qty",
            "fieldtype": "Float",
            "width": 130
        },
        {
        ...
        {
            "label": "Remaining Issue Qty",
            "fieldname": "remaining_issue_qty",
            "fieldtype": "Float",
            "width": 150
        },
        {
        ...
        },
        {
            ...
            "fieldname": "grn_pending_qty",
            "fieldtype": "Float",
            "width": 140
        },
        {
            "label": "L1 Approval",
            "fieldname": "l1_approval",
            "width": 180
        },
        {
            "label": "L2 Approval",
            "fieldname": "l2_approval",
            "width": 180
        },
        {
            "label": "L3 Approval",
            "fieldname": "l3_approval",
            "width": 180
        }
    ]
...
def get_data(filters):
    ...
    data = frappe.db.sql(f"""
        SELECT
            ...
            -- User & Department (full concatenated)
            CASE
                WHEN mi.custom_username LIKE '%% - %%'
                THEN CONCAT(
                    TRIM(SUBSTRING_INDEX(mi.custom_username, ' - ', 1)),
